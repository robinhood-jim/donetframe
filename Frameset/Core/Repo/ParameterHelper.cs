...
namespace Frameset.Core.Repo
{
    ...
    {
        internal static IList<DbParameter> AddQueryParam(IJdbcDao dao, FieldContent content, StringBuilder whereBuilder, int paramStartPos, Constants.SqlOperator oper, object[] values)
        {
