...
public interface ISqlDialect
{
    ...
    DbCommand GetDbCommand(DbConnection connection, string sql, DbTransaction transaction);
    ...
    int BatchInsert<T>(IJdbcDao dao, DbConnection dbConnection, List<T> entitys);
}